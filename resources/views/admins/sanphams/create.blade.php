                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="mb-3">
                                ...
                                @error('ma_san_pham') is-invalid @enderror" value="{{old('ma_san_pham')}}" placeholder="">
                                @error('ma_san_pham')
                            ...
                            <div class="mb-3">
                                ...
                                @error('ten_san_pham') is-invalid @enderror" value="{{old('ten_san_pham')}}" placeholder="Nhập tên sản phẩm">
                                @error('ten_san_pham')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @error('gia_san_pham') is-invalid @enderror" value="{{old('gia_san_pham')}}" placeholder="Nhập giá sản phẩm">
                                @error('gia_san_pham')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @error('gia_khuyen_mai') is-invalid @enderror " value="{{old('gia_khuyen_mai')}}" placeholder="Khuyến mãi">
                            ...
                            <div class="mb-3">
                               ...
                               " name="danhmuc_id">
                                    ...
                                    <option value="{{$danhMuc->id}}" {{old('gia_khuyen_mai') == $danhMuc->id ? 'selected' : ''}}>
                            ...
                            <div class="mb-3">
                                ...
                                @error('so_luong') is-invalid @enderror" value="{{old('so_luong')}}" placeholder="Số lượng sản phẩm">
                                @error('so_luong')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                @error('ngay_nhap') is-invalid @enderror" value="{{old('ngay_nhap')}}" placeholder="Ngày nhập sản phẩm">
                                @error('ngay_nhap')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="mo_ta_ngan" class="form-control
                                 @error('mo_ta_ngan') is-invalid @enderror" id="mo_ta_ngan" row="3" placeholder="Mô tả ngắn">{{old('mo_ta_ngan')}}</textarea>
                                @error('mo_ta_ngan')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                                    ...
                                    <tbody id="image-table-body">
                                        <tr>
                                            <td class="d-flex align-items-center">
                                                <img src="https://www.shutterstock.com/image-vector/img-vector-icon-design-on-260nw-2164648583.jpg" id="preview_0" alt="Hình ảnh sản phẩm" style="width: 75px ">
                        ...
                        <div class="col-sm-10 d-flex gap-2">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_type" id="gridRadios1" value="0" checked>
                                <label class="form-check-label text-danger" for="gridRadios1">
                                    Ẩn
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_type" id="gridRadios2" value="1">
...
<script>
    ...
    document.getElementById('add-row').addEventListener('click', function() {
        ...
        newRow.innerHTML = `
            <td class="d-flex align-items-center">
                <img src="https://www.shutterstock.com/image-vector/img-vector-icon-design-on-260nw-2164648583.jpg" id="preview_${index}" alt="Hình ảnh sản phẩm" style="width: 75px">
                <input type="file" id="hinh_anh_${index}" name="list_hinh_anh[id_${index}]" class="form-control" onchange="previewImage(this, ${index})">
            </td>
            <td>
