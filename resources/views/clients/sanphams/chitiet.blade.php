                            ...
                            <div class="product-details-des">
                                ...
                                <form action="{{route('cart.add')}}" method="post">
                                    ...
                                    <div class="quantity-cart-box d-flex align-items-center">
                                        ...
                                        <div class="quantity">
                                            <div class="pro-qty"><input type="text" name="quantity" id="quantityInput" value="1"></div>
                                            <input type="hidden" name="product_id" id="" value="{{ $sanPham->id}}">
                                        </div>
                    ...
                    <div class="product-item">
                        ...
                        <div class="product-caption text-center">
                            ...
                            <div class="price-box">
                                ...
                                <span class="price-regular">{{number_format($item->gia_san_pham,0 , '','.')}}đ</></span>
